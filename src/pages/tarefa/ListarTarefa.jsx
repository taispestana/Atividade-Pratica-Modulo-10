...
const initialRows = [
  createData(1, 'Tarefa 1', 'Descrição da Tarefa 1', '2022-01-01', '2022-01-02', 'Aguardando', 'Recurso 1'),
  createData(2, 'Tarefa 2', 'Descrição da Tarefa 2', '2022-01-03', '2022-01-04', 'Aguardando', 'Recurso 2'),
...
const ListarTarefa = () => {
  ...
  const handleEditar = (id) => {
    ...
    // Setar como true o state responsável pela exibição do Model de Editar Tarefa
    setOpenEditar(true);
  };
